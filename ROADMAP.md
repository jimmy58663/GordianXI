...
- [ ] **Phase 5F: World Collision, Terrain Navigation & Ground Physics (MVP Completion — Blocking):**
  ...
  - [ ] **Entity Collision:** NPCs and monsters block the player (the layer Windower's JA0Wait turns off); `CollisionLayers.Entities` toggle already exists.
